...
MappingStats <- data.table(stats =  c("#HGNC Symbol in the transcriptomics dataset",
                                     "#unique Entrez IDs",
                                     "#missing mappings for HGNC Symbol to Entrez IDs",
                                     "#one-to-many mappings for Entrez IDs",
                                     "#unique Ensembl IDs",
                                     "#missing mappings for HGNC Symbol to Ensembl IDs",
...
order <- c("#HGNC Symbol in the transcriptomics dataset" = 1,
           "#unique Entrez IDs" = 2,
           "#missing mappings for HGNC Symbol to Entrez IDs" = 3, 
           "#one-to-many mappings for Entrez IDs" = 4,
           "#unique Ensembl IDs" = 5, 
           "#missing mappings for HGNC Symbol to Ensembl IDs" = 6, 
...
ggplot(MappingStats_toPlot, aes(x = variable, y = reorder(stats, -order), fill = value)) +
