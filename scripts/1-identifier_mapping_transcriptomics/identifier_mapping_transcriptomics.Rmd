...
suppressPackageStartupMessages({
  ...
  library(BridgeDbR) #This is the BridgeDb annotation package containing multiple species, using Ensembl Gene IDs ("En") as primary key.
  library(dplyr)
  library(rmarkdown)
  library(data.table)
  library(knitr)
...
##Set the working directory to download the GeneProtein mapping file
location <- "data/Hs_Derby_Ensembl_105.bridge"
...
##Set the working directory to download the GeneProtein mapping file
location <- "data/hgnc_primaryToSecondaryIDs.bridge"
checkfile <- paste0(getwd(), '/' ,location)
