...
combined_ileum_CD_multi <- rbind(tSet_ileum_CD, mSet_CD)
combined_rectum_CD_multi <- rbind(tSet_rectum_CD, mSet_CD)
combined_ileum_UC_multi <- rbind(tSet_ileum_UC, mSet_UC)
combined_rectum_UC_multi <- rbind(tSet_rectum_UC, mSet_UC)

##Remove NA values for missing IDs.
dfs <- c("combined_ileum_CD_multi", "combined_rectum_CD_multi", "combined_ileum_UC_multi", "combined_rectum_UC_multi")
